...
.modal(:class="{ 'is-active': modals.agents.showDeploy }")
    ...
    .modal-card 
                    ...
                    .control 
                        .select 
                            select(v-model="selectedDeployableAbility" @change="selectDeployableAbility()")
                                option(disabled selected value="") 请选择代理
                    ...
                    .field.is-horizontal.mb-2
                        ...
                        .field-body
                            .field.has-addons
                                ...
                                .control 
                                    a.button.has-tooltip-arrow(title="重置为默认值" @click="field.value = agentFieldConfig[field.name]")
                                        span.icon
        ...
        footer.modal-card-foot.is-flex.is-justify-content-flex-end 
            button.button(@click="modals.agents.showDeploy = false") 关闭
</template>
