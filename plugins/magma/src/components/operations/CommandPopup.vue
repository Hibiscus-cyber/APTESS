...
.buttons.p-2(v-if="isLinkEditable(props.link)")
    button.button.is-primary(@click="operationStore.updateLink($api, -3, editableCommand, props.link)") 批准
    button.button.is-danger.ml-auto(@click="operationStore.updateLink($api, -2, null, props.link)") 丢弃 
</template>
