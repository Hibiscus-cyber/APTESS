...
tr(id="manual-input-command")
    ...
    td
        .is-flex.is-flex-direction-column.is-justify-content-center
            button.button.is-primary(@click="addManualCommand()" :disabled="!manualCommand.paw || !manualCommand.executor.command || !manualCommand.executor.name") 添加命令
            button.button.mt-2(@click="modals.operations.showAddManualCommand = false") 取消
</template>
