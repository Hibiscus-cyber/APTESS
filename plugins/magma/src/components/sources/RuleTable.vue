...
table.table.is-striped.is-fullwidth
    ...
    tbody
        tr(v-for="(rule, index) of selectedSource.rules")
            td 
                input.input(v-if="ruleIndexToEdit === index" v-model="rule.trait" placeholder="规则特征")
            ...
            td 
                input.input(v-if="ruleIndexToEdit === index" v-model="rule.match" placeholder="规则匹配条件")
